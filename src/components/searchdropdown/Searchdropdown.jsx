        ...
        >
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={() => {
              ...
              dispatch(filterByOrderStatus("all"));
            }}
          >
            All
          </DropdownMenuCheckboxItem>
          ...
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={() => {
              setcheckboxstatus("pending");
              dispatch(filterByOrderStatus("pending"));
            }}
          >
            Pending
          </DropdownMenuCheckboxItem>
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={() => {
              setcheckboxstatus("processing");
              dispatch(filterByOrderStatus("processing"));
            }}
          >
            Processing
          </DropdownMenuCheckboxItem>
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={() => {
              setcheckboxstatus("delivered");
              dispatch(filterByOrderStatus("delivered"));
            }}
          >
            Delivered
          </DropdownMenuCheckboxItem>
